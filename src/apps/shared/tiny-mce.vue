<script lang="ts" setup>
  ...
  const state = {
    ...
    config: ref({
      ...
      plugins: "mergetags anchor autolink charmap code codesample emoticons image link lists media searchreplace table visualblocks wordcount pagebreak checklist mediaembed casechange export formatpainter pageembed a11ychecker permanentpen powerpaste advtable advcode editimage tableofcontents footnotes mergetags autocorrect",
  ...
  watch(() => props.variables, variablesNew => {
    ...
    let plugins = "tinymcespellchecker anchor autolink charmap code codesample emoticons image link lists media searchreplace table visualblocks wordcount pagebreak checklist mediaembed casechange export formatpainter pageembed a11ychecker powerpaste advtable advcode editimage tableofcontents footnotes autocorrect autoresize";
